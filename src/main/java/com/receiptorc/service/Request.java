...
public class Request implements IMakeRequest {
    ...
    /**
     * The goal is make a request. This function was thought to cover more of one situation.
     ...
     */
    @Override
    public String makeRequest(MultipartEntityBuilder builder, String url, Map<String, String> headers, String body) {
